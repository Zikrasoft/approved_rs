...
translations:
  en:
    ...
    body: >
      ...
      Our auto service in Belgrade recently completed a full maintenance service
      on a **Mercedes-Benz C-Class W205**.
      ...
      the most important safety components of any vehicle**, so regular
      inspection and timely replacement are essential. During brake service, it
      is important to inspect not only the pads but also the brake discs,
      calipers and guides to ensure proper and even braking.


      Regular Mercedes-Benz maintenance helps prevent more expensive repairs,
  ...
  sr:
    ...
    body: >
      ...
      U našem auto-servisu u Beogradu obavili smo kompletan servis na
      **Mercedes-Benz C-Class W205**.
      ...
      najvažnijih sistema za bezbednost vozila**, zato je njegova redovna
      kontrola veoma važna. Prilikom zamene pločica potrebno je proveriti i
      stanje diskova, čeljusti i vođica kako bi kočenje bilo pravilno i
      ravnomerno.


      Redovno održavanje Mercedes-Benz vozila pomaže da se spreče ozbiljniji
