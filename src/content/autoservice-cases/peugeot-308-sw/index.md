...
translations:
  ...
  es:
    title: Peugeot 308 SW
    body: |-
      Gran servicio del Peugeot 308 2024 en un taller ruso en Belgrado

      Recibimos a un Peugeot 308 2024 con motor diésel 1.5 BlueHDi para su mantenimiento. Llevamos a cabo un servicio completo de gran tamaño.

      Dentro del mantenimiento se realizaron las siguientes tareas:
      ...
      - cambio de filtros;
      - revisión y mantenimiento de todos los componentes asociados.

      Es importante prestar especial atención a la cadena de distribución cuando se trabaja con el motor 1.5 BlueHDi.

      En versiones anteriores de este motor, se utilizaba una cadena de 7 mm de ancho. Con el tiempo, puede estirarse y, en el peor de los casos, romperse, lo que puede ocasionar daños graves al motor.

      Durante el mantenimiento de estos motores, se recomienda la instalación de una cadena reforzada de 8 mm junto con las bases de los árboles de levas y los propios árboles.

      El Peugeot 308 de los años 2023-2024 ya viene equipado con una cadena de 8 mm.

      Por lo tanto, al realizar un gran servicio es fundamental tener en cuenta no solo el estado de la correa de distribución, sino también el estado de la cadena de los árboles de levas y todas las características específicas del motor.

      El taller ruso en Belgrado ofrece mantenimiento y reparación de Peugeot, Citroën, Opel y otros vehículos: diagnóstico, mantenimiento preventivo, cambio de la correa de distribución, y mantenimiento de motores y transmisiones.
  de:
    title: Peugeot 308 SW
    body: |-
      Umfassender Service für den Peugeot 308 2024 in einer russischen Werkstatt in Belgrad

      In unsere Werkstatt kam ein Peugeot 308 2024 mit einem 1,5-Liter-BlueHDi-Diesel-Motor zur Wartung. Wir führten einen vollständigen Wartungsservice durch.

      Im Rahmen des Services wurden folgende Maßnahmen durchgeführt:
      ...
      - Überprüfung und Wartung aller zugehörigen Komponenten.

      Besondere Aufmerksamkeit ist beim Arbeiten mit dem 1,5-Liter-BlueHDi-Motor auf die Steuerkette zu legen.

      Bei früheren Versionen des Motors kam eine 7 mm breite Kette zum Einsatz. Im Laufe der Zeit kann sie sich dehnen, und im schlimmsten Fall kann sie brechen und schwere Motorschäden verursachen.

      Bei der Wartung solcher Motoren wird empfohlen, eine verstärkte 8 mm Kette zusammen mit den Steuerlager und Nockenwellen zu installieren.

      Im Peugeot 308 der Baujahre 2023-2024 wird bereits die 8 mm Kette verbaut.

      Daher ist es bei der Durchführung eines umfassenden Services wichtig, nicht nur den Zustand des Zahnriemens, sondern auch den Zustand der Nockenwellenkette sowie alle bekannten Besonderheiten des spezifischen Motors zu berücksichtigen.

      Die russische Werkstatt in Belgrad bietet technische Wartung und Reparaturen für Peugeot, Citroën, Opel und andere Fahrzeuge an: Diagnosen, Inspektionen, Austausch von Zahnriemen, Motor- und Getriebewartung.
car: Peugeot 308 SW
year: 2024
servicesApplied:
  - diagnostics
...
На более ранних версиях двигателя использовалась цепь шириной 7 мм. Со временем она может растягиваться, а в худшем случае — разрушиться и привести к серьёзным повреждениям двигателя.

При обслуживании таких двигателей рекомендуется установка усиленной цепи 8 мм вместе с постелью распредвалов и распредвалами.
