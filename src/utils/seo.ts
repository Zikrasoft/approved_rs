...
// ponytail: privoz has no dedicated OG asset yet (gen-og.mjs untouched,
// out of scope for a test build) — reuses autopodbor's image as a
// placeholder. One helper instead of the same string + comment copy-pasted
// on every privoz page; swap the source key here once real assets exist.
export const placeholderOgImage = (baseUrl: string, locale: Locale): string =>
  `${baseUrl}/og/autopodbor${OG_SUFFIX[locale]}.png`;
