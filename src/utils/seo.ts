...
// og/<slug>.png is the ru default (unsuffixed); en/sr/es/de variants are
// generated by scripts/gen-og.mjs as og/<slug>-en.png / -sr.png / -es.png /
// -de.png. `slug` IS the filename — no separate lookup map needed.
export const OG_SUFFIX: Record<Locale, string> = { ru: '', en: '-en', sr: '-sr', es: '-es', de: '-de' };
...
const SIMPLE_LOCATION_PREPOSITION: Record<'en' | 'es' | 'de', string> = { en: 'in', es: 'en', de: 'in' };
