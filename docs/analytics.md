...
| `form_start`                                                     | первый фокус в поле формы                       | —                                               |
| `form_error`                                                     | отправку отбила валидация                       | `field`: `name`, `telegram`, `phone`, `consent` |
...
Обработчик смотрит на `event.defaultPrevented` в следующем тике:
